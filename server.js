  ...
  try {
    ...
    const formattedData = responses.map((response) => {
      const baseData = {
        ...
        Location: response.location || "Not specified", // Add location field
    ...
    const fields = ["Name", "Location", "Survey Title", "Department", "Tenure", "Submission Date", "Submission Time"]
...
app.post("/api/responses", async (req, res) => {
  try {
    ...
    const { surveyId, userId, department, tenure, answers, name, location } = req.body
    ...
    const response = new Response({
      ...
      location: location || "Not specified", // Store the location
      department,
      answers,
      tenure,
    })
